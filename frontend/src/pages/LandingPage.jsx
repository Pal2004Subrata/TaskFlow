      ...
      <nav className="sticky top-0 z-50 bg-white/70 dark:bg-slate-950/70 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-800/50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600 dark:text-slate-300">
            <a href="#features" className="relative group hover:text-slate-900 dark:hover:text-white dark:hover:text-white transition-all duration-300 hover:scale-110 inline-block">
              Features
            ...
            <a href="#solutions" className="relative group hover:text-slate-900 dark:hover:text-white dark:hover:text-white transition-all duration-300 hover:scale-110 inline-block">
              Solutions
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-indigo-600 dark:bg-indigo-500 transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a href="#resources" className="relative group hover:text-slate-900 dark:hover:text-white dark:hover:text-white transition-all duration-300 hover:scale-110 inline-block">
              Resources
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-indigo-600 dark:bg-indigo-500 transition-all duration-300 group-hover:w-full"></span>
            </a>
          </div>
