      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-2 w-80 bg-white border border-slate-200 rounded-2xl shadow-xl z-50 overflow-hidden flex flex-col"
                  ...
                  >
                    <div className="flex justify-between items-start gap-3">
                      <div className="flex-1">
                        ...
                        <p className={`text-xs mt-0.5 leading-relaxed ${notification.read ? 'text-slate-500' : 'text-slate-600'}`}>
                      ...
                      {!notification.read && (
                        <button 
                          ...
                          className="text-[10px] font-medium text-indigo-600 hover:text-indigo-800 bg-indigo-100 hover:bg-indigo-200 px-2 py-1 rounded-md transition-colors shrink-0 flex items-center gap-1 mt-1"
                        >
